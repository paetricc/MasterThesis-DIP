...
Výsledky experimentů s chladicími plány, jenž nevyužívají parametr míry ochlazování, jsou zobrazeny na obrázku~\ref{fig:qisa-boxplot}. 
...
\begin{figure}[ht!]
    ...
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\linewidth]{qse/qiga_convergence_250_velocity_1.0_population_5.pdf}
    \end{subfigure}
...
Výsledky těchto experimentů jsou zobrazeny na obrázku~\ref{fig:qse-250-mix}. 
...
\begin{table}[ht!]
    ...
    \begin{tabular}{c c c c c c c c c}
        ...
        & & & & \textbf{1\,000}    & \textbf{2\,000}     & \textbf{5\,000} & \textbf{10\,000}\\
        \midrule
        100 & 0,5 & 0,25 & 0,01  & 54\,503 & 110\,592 & 275\,805 & 553\,302 \\
        \midrule
...
\begin{figure}[ht!]
    ...
    \hfill
    \begin{subfigure}[b]{0.24\textwidth}
        \includegraphics[width=\linewidth]{qipso/boxplot_qipso_10000_large.pdf}
    \end{subfigure}
...
S rostoucími velikostmi instancí se mezi algoritmy začínají výrazněji projevovat rozdíly ve kvalitě nalezených řešení. 
